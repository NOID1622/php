...
<body>
   ...
   <table>
        <input type="hidden" name="idBarang" value="<?php if ($_GET['id'] != ""){echo $_GET['id'];}else {echo "";} ?>">
        <tr>
            <td>Nama Barang : </td>
            <td><input type="text" name="namaBarang" max="30" value="<?php if ($_GET['id'] != ""){echo $_GET['id'];} {echo $oldNamaBarang;} ?>"></td>
        </tr>
        <tr>
            <td>Jumlah Barang : </td>
            <td><input type="number" name="jumlahBarang" value="<?php if ($_GET['id'] != ""){echo $_GET['id'];} {echo $oldstock;} ?>"></td>
        </tr>
        <tr>
            <td>Harga Barang : </td>
            <td><input type="text" name="hargaBarang" value="<?php if ($_GET['id'] != ""){echo $_GET['id'];} {echo $oldHarga;} ?>"></td>
        </tr>
        <tr>
            <td>Promo : </td>
            <td>
